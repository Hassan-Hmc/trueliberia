...
const as=["Restaurants","Hotels & Resorts","Gym & Fitness","Nightclubs & Bars","Beaches & Outdoors","Beauty & Spy","Shopping",]
const [def, setdef] = useState()
const [sug, setsug] = useState(true)
  return (
    <SafeAreaProvider>
    ...
    onRefresh={_onRefresh1}tintColor="#F8852D"/>
                 ...
                 <View style={styles.container}>
                     ...
                     <View style={styles.searchSection}>
                         ...
                         <TextInput defaultValue={def}   onChangeText={(e)=>{settype(e)}}  style={styles.input} placeholder="Search here...."
...
{as.map((v,i)=>{
  ...
  <TouchableOpacity onPress={()=>{setdata(true);fetch_keyword_data(v);setdef(v)}} key={i} style={{marginLeft:'8%',marginTop:'2%'}}>
  <Text style={{fontSize:15,fontWeight:'bold',color:'#00296B'}}>{v}</Text>
  </TouchableOpacity>
